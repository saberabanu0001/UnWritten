...
from app.schemas.ai import ProseGenerateResponse, SceneExtractResponse
from app.services.gemini_client import generate_image_bytes, generate_text
from app.utils.prompts import IMAGE_PROMPT_TEMPLATE, PROSE_GENERATE_PROMPT, SCENE_EXTRACT_PROMPT
...
async def generate_prose(
    ...
    prompt = PROSE_GENERATE_PROMPT.format(
        ...
        followup_answer=followup_answer or "",
        language=language,
    )
    try:
        text = await generate_text(prompt, json_mode=True)
